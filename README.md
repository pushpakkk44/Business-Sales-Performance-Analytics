 ...
 * Find profitable countries and customers
...
Dataset
* CSV sales dataset
* Includes product, customer, quantity, price, invoice date, and country details
Features
* Data Cleaning
* Revenue Analysis
...
6.Write business insights and conclusions
Results
* Identified top revenue-generating products
* Analyzed monthly sales growth
* Found high-performing countries and customers
